...
const LocationFinder = () => {
    ...
    const handleSearch = async (cityOrZipCode) => {
        ...
        let url = `${STORE_API_BASE_URL}api/stores?cityOrZipCode=${cityOrZipCode}${locationTypesQueryParamsString}&includeWaitTime=true&includeDistanceFromUserLocation=true&includeCoordinates=true`;
